        ...
        for range_start, range_end in angle_range:
            ...
            while theta < range_end:
                ...
                while r <= max_r:
                    ...
                    cells.append(
                        # Internal propagation samples use a slotted dataclass so the
                        # large radial lattice does not allocate a per-cell __dict__.
                        WorldCell(
                            lat=lat,
                            lon=lon,
                            distance_m=r,
                            ...
                            buildings_along_path=(list(encountered_buildings) if encountered_buildings is not None else None),
