...
app = FastAPI(title="ISAC RF Planner API")
...
logging.getLogger("isac_rf_planner").setLevel(logging.DEBUG)
logging.getLogger("isac_rf_planner.agents").setLevel(logging.DEBUG)
logging.getLogger("isac_rf_planner.geo").setLevel(logging.DEBUG)
logging.getLogger("isac_rf_planner.api").setLevel(logging.DEBUG)
